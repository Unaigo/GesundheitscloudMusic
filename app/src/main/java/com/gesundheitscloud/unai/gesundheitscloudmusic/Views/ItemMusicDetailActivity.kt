...
/**
 * An activity representing a single ItemMusic detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a [ItemMusicListActivity].
 */
class ItemMusicDetailActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_itemmusic_detail)
        ...
        if (savedInstanceState == null) {
            ...
            supportFragmentManager.beginTransaction()
                .add(R.id.itemmusic_detail_container, fragment)
                .commit()
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
        when (item.itemId) {
            android.R.id.home -> {
                ...
                navigateUpTo(Intent(this, ItemMusicListActivity::class.java))
                true
            }
